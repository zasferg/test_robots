...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "test_email_sender@example.com"  # Замените на ваш email
EMAIL_HOST_PASSWORD = "test_password"  # Замените на ваш пароль
DEFAULT_FROM_EMAIL = (
    "test_email_receiver@example.com"  # Замените на ваш email отправителя
)
